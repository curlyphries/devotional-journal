...
urlpatterns = [
    ...
    path(
        "explorations/", ExplorationHistoryListView.as_view(), name="exploration-list"
    ),
    path(
        "explorations/<uuid:exploration_id>/",
        ExplorationHistoryDetailView.as_view(),
        name="exploration-detail",
    ),
    path(
        "explorations/<uuid:exploration_id>/bookmark/",
        ExplorationBookmarkView.as_view(),
        name="exploration-bookmark",
    ),
]
