...
urlpatterns = [
    ...
    path('<uuid:group_id>/engagement/', GroupEngagementView.as_view(), name='group-engagement'),
    path('<uuid:group_id>/set-plan/', SetGroupPlanView.as_view(), name='group-set-plan'),
]
