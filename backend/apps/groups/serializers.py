...
class GroupMembershipSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'user_email', 'user_display_name', 'role', 'joined_at', 'is_active']
...
class GroupSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Group
        fields = [
            'id', 'name', 'description', 'created_by_name', 'invite_code',
            'active_plan', 'max_members', 'tier', 'member_count', 'created_at'
        ]
...
class GroupEngagementSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ['date', 'total_members', 'members_active_today', 'avg_streak', 'plan_completion_pct']
