...
urlpatterns = [
    ...
    # Thread prompts
    path('thread-prompts/pending/', ThreadPromptPendingView.as_view(), name='thread-prompts-pending'),
    path('thread-prompts/<uuid:thread_id>/respond/', ThreadPromptRespondView.as_view(), name='thread-prompt-respond'),
    # Milestones & Growth
    ...
    path('crew/weekly-review/', CrewView.as_view(), {'action': 'weekly-review'}, name='crew-weekly-review'),
    path('crew/monthly-recap/', CrewView.as_view(), {'action': 'monthly-recap'}, name='crew-monthly-recap'),
    path('crew/ask-agent/', CrewView.as_view(), {'action': 'ask-agent'}, name='crew-ask-agent'),
    path('insights/scripture/', ScriptureInsightView.as_view(), name='scripture-insights'),
    # Admin endpoints
    path('admin/quality-report/', DevotionalQualityReportView.as_view(), name='quality-report'),
]
