...
LIFE_AREAS = [
    {
        ...
        'display_order': 1,
        'scripture_tags': [
            'truth', 'honest', 'lie', 'deceive', 'word', 'promise',
            'faithful', 'trustworthy', 'upright', 'blameless'
        ],
        'reflection_prompts': [
    ...
    },
    {
        ...
        'display_order': 2,
        'scripture_tags': [
            'love', 'neighbor', 'brother', 'wife', 'children', 'father',
            'friend', 'family', 'marriage', 'forgive', 'reconcile'
        ],
        'reflection_prompts': [
    ...
    },
    {
        ...
        'display_order': 3,
        'scripture_tags': [
            'work', 'labor', 'diligent', 'lazy', 'serve', 'calling',
            'purpose', 'provision', 'excellence', 'steward'
        ],
        'reflection_prompts': [
    ...
    },
    {
        ...
        'display_order': 4,
        'scripture_tags': [
            'tempt', 'flesh', 'spirit', 'desire', 'lust', 'anger',
            'patient', 'discipline', 'self-control', 'sober', 'alert'
        ],
        'reflection_prompts': [
    ...
    },
    {
        ...
        'display_order': 5,
        'scripture_tags': [
            'pray', 'trust', 'faith', 'believe', 'obey', 'word',
            'worship', 'praise', 'meditate', 'seek', 'follow'
        ],
        'reflection_prompts': [
    ...
    },
    {
        ...
        'display_order': 6,
        'scripture_tags': [
            'give', 'serve', 'help', 'poor', 'generous', 'sacrifice',
            'tithe', 'offering', 'compassion', 'mercy', 'need'
        ],
        'reflection_prompts': [
    ...
    },
    {
        ...
        'display_order': 7,
        'scripture_tags': [
            'learn', 'humble', 'grow', 'renew', 'transform', 'wisdom',
            'teachable', 'correction', 'change', 'mature', 'sanctify'
        ],
        'reflection_prompts': [
