...
class JournalEntrySerializer(serializers.ModelSerializer):
    ...
    focus_intention_id = serializers.UUIDField(source='focus_intention.id', read_only=True)

    class Meta:
        model = JournalEntry
        fields = [
            'id', 'date', 'plan_enrollment', 'plan_day',
            'focus_intention_id', 'focus_themes',
...
class JournalEntryListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = JournalEntry
        fields = ['id', 'date', 'mood_tag', 'focus_themes', 'content_preview', 'created_at']
