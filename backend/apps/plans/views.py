...
class PlanDetailView(APIView):
    ...
    def get(self, request, plan_id):
        try:
            plan = ReadingPlan.objects.prefetch_related('days').get(id=plan_id, is_active=True)
...
class EnrollView(APIView):
    ...
    def post(self, request, plan_id):
        ...
        serializer = UserPlanEnrollmentSerializer(enrollment, context={'request': request})
...
class EnrolledPlansView(APIView):
    ...
    def get(self, request):
        ...
        serializer = UserPlanEnrollmentSerializer(enrollments, many=True, context={'request': request})
        return Response(serializer.data)
...
class TodayReadingView(APIView):
    ...
    def get(self, request, enrollment_id):
        ...
        return Response({
            'enrollment': UserPlanEnrollmentSerializer(enrollment, context={'request': request}).data,
            'day': {
