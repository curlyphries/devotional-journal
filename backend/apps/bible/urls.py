...
from .views import (
    TranslationListView, PassageReadView, SearchView,
    BollsTranslationsView, BollsPassageView, BollsSearchView, BollsVerifyView,
...
urlpatterns = [
    ...
    path('bolls/translations/', BollsTranslationsView.as_view(), name='bolls-translations'),
