...
def get_chapter(translation: str, book: str, chapter: int) -> Optional[list]:
    ...
    if translation not in ALLOWED_TRANSLATIONS:
        raise BollsAPIError(f"Translation '{translation}' not allowed. Use one of: {list(ALLOWED_TRANSLATIONS.keys())}")
...
def get_verse_range(translation: str, book: str, chapter: int, start_verse: int, end_verse: int) -> list:
    """
...
BOOK_MAPPINGS = {
    ...
    'songofsolomon': 'SNG', 'song': 'SNG', 'sos': 'SNG', 'sng': 'SNG',
    'isaiah': 'ISA', 'isa': 'ISA',
